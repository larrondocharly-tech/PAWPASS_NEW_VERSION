    ...
    <main style={{ background: "#FAFAF5" }}>
      <div className="container" style={{ maxWidth: 1120 }}>
        ...
        <div className="mobile-only">
          ...
          {/* HERO MOBILE avec fond à pattes + illustration SPA */}
          <section
            className="hero-card"
            style={{
              background: "#FFFFFF",
          ...
          >
            Pas encore de compte ? Scannez un commerçant, validez votre achat et
            créez votre compte après.
          </p>
        </div>
        ...
        <div className="desktop-only">
          ...
          >
            ...
            {/* Carte résumé comme avant (sans illustration SPA pour ne pas casser le layout) */}
