        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              ...
              <p className="helper" style={{ fontSize: '1rem', color: '#666666' }}>
                PawPass transforme vos achats chez les commerçants partenaires en cashback
                solidaire, utilisable en réduction ou en don à une SPA locale.
              </p>
            </div>
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <Link
        ...
        <section id="avantages" style={{ marginTop: 48 }}>
          ...
          <div className="grid grid-2" style={{ marginTop: 16 }}>
            {[
              ...
              <div key={item.title} className="card" style={{ padding: 20, borderRadius: 16 }}>
          ...
          <div className="card" style={{ borderRadius: 16 }}>
            ...
            <div className="grid grid-2" style={{ marginTop: 16 }}>
              {[
                ...
                <div key={item} className="card" style={{ padding: 16, borderRadius: 16 }}>
                  {item}
                </div>
              ))}
            </div>
