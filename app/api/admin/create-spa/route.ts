...
function getBaseUrl(req: Request) {
  // Priorité à NEXT_PUBLIC_SITE_URL, sinon fallback sur l'origin de la requête
...
export async function POST(req: Request) {
  try {
    ...
    // IMPORTANT: doit être autorisée dans Supabase > Auth > URL Configuration > Redirect URLs
