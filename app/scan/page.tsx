...
interface Merchant {
  id: string;
  name: string;
  cashback_rate?: number; // en %, si tu l'as dans ta BDD
}
        ...
        {showRedeemConfirmation && redeemStep === "CONFIRM" && (
          ...
          >
            ...
            >
              ...
              {/* Tu peux ajouter ici la date + le timer comme dans ta capture
                  en reprenant ton code existant si tu le souhaites. */}
        ...
        {showRedeemConfirmation && redeemStep === "REMAINING" && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => {
                  // ICI : si tu veux enregistrer ce cashback en BDD,
                  // on ajoutera un appel Supabase propre quand tu m’auras
                  // donné la structure exacte (transactions, wallet, don, etc.).
                  // Pour l’instant, on revient simplement au dashboard.
